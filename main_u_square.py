...
if __name__ == "__main__":
    ...
    eoc_square = PoissonMixedEOC(0,i_max=7,degree=1)
    eoc_square.computeError(uh_exact, uh_exact, 2)
    # eoc_square.computePlot()
    eoc_square.computeSave(uh_exact, uh_exact, 2,filename_flag=filename_flag)
